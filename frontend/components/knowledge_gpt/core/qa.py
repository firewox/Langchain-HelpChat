# @Time  :2024/12/22 1:02
# @Author: yutian.li
# @Email : lyutian2020@qq.com
from typing import List
from langchain.chains.qa_with_sources import load_qa_with_sources_chain
from frontend.components.knowledge_gpt.core.prompts import STUFF_PROMPT
from langchain.docstore.document import Document
from frontend.components.knowledge_gpt.core.embedding import FolderIndex
